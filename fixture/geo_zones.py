...
class GeoZonesHelper:
    ...
    def table_get_rows(self):
        ...
        elems = driver.find_element_by_name('geo_zones_form').find_elements_by_class_name('row')
        return elems

    # def table_click_link_by_value(self, text):
    ...
    def table_get_cels_value_dict(self):
        # вернуть пару словаря имя и количество
        pass
    ...
    def table_get_header_value(self):
        data = []
        driver = self.app.driver
        elems = driver.find_element_by_name('geo_zones_form').find_element_by_class_name('header').find_elements_by_tag_name('th')
        for elem in elems:
